...
//        front_sensor.enableLed(true);   // turn on the sensor LED
        ...
        telemetry.addData("START rotate1 ZeroP behavior: ", "rotate1=%s", rotate1.getZeroPowerBehavior());
        telemetry.addData("START rotate2 ZeroP behavior: ", "rotate2=%s", rotate2.getZeroPowerBehavior());
...
//            telemetry.addData("LIFT1 motor current pos: ", "%d, Color = %s", get_lift1_motor_enc(), detected_color);
            ...
            telemetry.addData("rotate2 pos:", "rotate2 =%d", get_rotate2_motor_enc());
            telemetry.addData("rotate2  power: ", "rotate2=%.2f", rotate2.getPower());
...
rightBackPower = Range.clip(rightBackPower * ConstantVariables.K_RB_ADJUST, -1.0, 1.0);
    ...
    public static void linearSlideSetPosition(DcMotor motor, int stageIndex, double power) {
        motor.setTargetPosition(stageIndex * 500);
